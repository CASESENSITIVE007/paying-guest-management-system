...
if(isset($_POST['submit'])){
	...
	$querry ="INSERT INTO room( Hostel_id, Room_No, price, description , Allocated) VALUES ('$hostel_id','$room_number','$price','$description',0)";
...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Add Form </h2>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="index.html">AMU<span class="display"></span></a>
		</div>

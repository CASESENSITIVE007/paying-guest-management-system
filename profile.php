	...
	<div class="main">
		<div id="navigation" style="display:none;" class="w3_agile">
			<ul>
				...
				<li>
					<a href="#"><i class="fa fa-folder" aria-hidden="true"></i><span>PG</span></a>
				</li>
				<li>
					...
					<fieldset class="step agileinfo w3ls_fancy_step">
						...
						<div class="abt-agile">
							...
							<div class="abt-agile-right">
								...
								<h3><?php echo $_SESSION['student_fname']." ".$_SESSION['student_lname']; ?></h3>
								<h5>Student</h5>
								<ul class="address">
									<li>

...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="admin_home.php">AMU <span class="display"></span></a></h1>
          ...
          <li class="nav-item">
						<a class="nav-link" href="create_hm.php">Appoint/Remove PG Manager</a>
					</li>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="../web_home/images/amu.png"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content">
						<div class="wrapper">
							<div class="text-center">
								<h2>Student Residential Allocator </h2>

	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home_manager.php">AMU<span class="display"></span></a></h1>
	...
	<div class="container">
			<div class="mail_grid_w3l">
				<form action="allocate_room.php" method="post">
					<div class="row">
					        <div class="col-md-9"> 
							<input type="text" placeholder="Search by ID" name="search_box">
							</div>
							<div class="col-md-3">
...
if(isset($_POST['submit'])){
   ...
   while($row1 = mysqli_fetch_assoc($result1)){
     ...
     $query2 = "SELECT  * FROM `application` WHERE Student_id=$student_id ";
     ...
     $student_id = $row1['Student_id'];
     $query3 = "UPDATE Application SET Application_status = '0' WHERE Student_id = '$student_id'";
     $result3 = mysqli_query($conn,$query3);
     /*echo "<script type='text/javascript'>alert('<?php echo $result3; ?>')</script>";*/
     if($result3){
		$query9 = "SELECT  * FROM `room` WHERE Room_no=$room_no ";
		$result9 = mysqli_query($conn,$query9);
		$row9 = mysqli_fetch_assoc($result9);
     	$room_id = $row9['Room_id'];

						...
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							<div class="contact-fields-w3ls">
								<select name="selected_option">
									<?php
									// $hostel=$_GET['id'];
									// $hos_man_id=$_GET['Hostle_man_id'];
									$hostel_name = $_GET['hostel_name'];
									$sql = "SELECT  Hostel_name  FROM hostel WHERE hostel_id!=6";
									$result = $conn->query($sql);
									// Check if there are rows in the result
									if ($result->num_rows > 0) {
										// Output data of each row
										while ($row = $result->fetch_assoc()) {
											echo "<option value='" . $row["Hostel_name"] . "'>" . "" . $row["Hostel_name"] . "</option>";
										}
									} else {
										echo "0 results";
									}
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="name" placeholder="Name"
									value="<?php echo $_SESSION['student_fname'] . " " . $_SESSION['student_lname']; ?>"
									required="">
							</div>
							<div class="contact-fields-w3ls">
								<input type="text" name="rol_no" placeholder="ID"
	...
	<footer class="py-5">
		<div class="container py-md-5">
			<div class="footer-logo mb-5 text-center">
				<a class="navbar-brand" href="https://www.amu.ac.in/" target="_blank">AMU <span
...
if (isset($_POST['submit'])) {
	...
	$hostel_name = $_POST['selected_option'];
